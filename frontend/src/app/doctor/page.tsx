    ...
    <main className="p-5 pt-0">
        ...
        <section className="m-auto p-2 grid grid-cols-2 lg:w-full w-fit lg:max-w-7xl items-stretch lg:grid-cols-4 gap-4">
          ...
          <div className="shadow border h-full sm:aspect-square border-gray-400 rounded-xl p-4 col-span-1">
            ...
            }} className="flex m-auto lg:mt-4 justify-center aspect-square items-center rounded-full w-[5.3rem] h-[5.3rem] sm:w-[6rem] sm:h-[6rem] lg:w-auto lg:h-[var(--boxEdge)]">
              <h4 className="bg-white flex justify-center items-center lg:text-3xl text-2xl rounded-full text-center w-[3.7rem] h-[3.7rem] sm:w-[4.5rem] sm:h-[4.5rem] lg:w-[75%] lg:h-[75%]">
                66%
              </h4>
            </div>
