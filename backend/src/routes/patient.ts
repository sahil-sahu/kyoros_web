...
import { createPatient, createPatientPeriodic, getDocs, getLatestlog, getNotes, getPatient, getPatientbyUhid, getPatients, makeNote, searchPatients, setCritcality } from '../controllers/patientController';
